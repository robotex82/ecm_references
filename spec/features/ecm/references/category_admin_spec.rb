...
feature 'Ecm::References::Category admin' do
  ...
  def set_resource_path
    @resource_path = "reference-categories"
  end

  def set_resource_class
    @resource_class = Ecm::References::Category
  end
  ...
  def fill_edit_form
    fill_in 'ecm_references_category[name]', :with => 'Updated category'
  end
